...
if [[ ! -d "$AUR_DIR" ]]; then
    ...
    echo ""
    echo -e "     ${GREEN}git clone ssh://aur@aur.archlinux.org/lichen.git $AUR_DIR${NC}"
    echo ""
    ...
    echo -e "     ${GREEN}git remote add origin ssh://aur@aur.archlinux.org/lichen.git${NC}"
    echo ""
...
echo -e "  ${BLUE}yay -S lichen${NC}"
echo "  or"
echo -e "  ${BLUE}paru -S lichen${NC}"
echo ""
